...
api_url = os.getenv('ROBOFLOW_API_URL', 'INVALID_API_URL')
api_key = os.getenv('ROBOFLOW_API_KEY', 'INVALID_API_KEY')
project_id = os.getenv('ROBOFLOW_PROJECT_ID', 'INVALID_PROJECT_ID')
