        ...
        <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
            <div class="themes-box">
                ...
                <div class="main-content">
                    <h5><a href="#" onclick="ipcRenderer.send('openAppWindow', '${JSON.stringify(app)}')">${app.name}</a></h5>
                    <div class="last-part">
                        <div class="right">
                            <p class="text">
                                by <a href="author-product.html" class="link">${app.company}</a> in <a href="product-two.html" class="link">Agency</a>
                            </p>
                            <div class="review">
